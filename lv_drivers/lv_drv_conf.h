...
#define LV_DRV_DELAY_US(us)  CyDelayUs(us)       /*Delay the given number of microseconds*/
#define LV_DRV_DELAY_MS(ms)  CyDelay(ms)       /*Delay the given number of milliseconds*/
...
#define LV_DRV_DISP_PAR_WR_WORD(data)    GraphicLCDIntf_Write16_A1(data)      /*Write a word to the parallel port*/
#define LV_DRV_DISP_PAR_WR_ARRAY(adr, n) GraphicLCDIntf_WriteM16_A1(adr, n)   /*Write 'n' bytes to Parallel ports from 'adr'*/
